...
export default function PartnerDashboard() {
    ...
    return (
        <div className="min-h-screen bg-[#f2f4f6]">
                        ...
                        <div className="flex justify-center">
                            <div className="overflow-x-auto no-scrollbar max-w-full">
                                <nav className="inline-flex items-center gap-1 bg-gray-100/50 p-1 rounded-2xl border border-gray-200/30">
                                    ...
                                    <NavButton id="retention2" label="유지율2" icon="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                    ...
                    <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-6 shrink-0">
                            ...
                            <nav className="hidden lg:flex items-center gap-1 bg-gray-100/50 p-1 rounded-2xl border border-gray-200/30">
                                ...
                                <NavButton id="retention2" label="유지율2 관리" icon="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                {partner?.role !== 'tm' && (
            ...
            <main className={`${activeTab === 'retention' || activeTab === 'retention2' ? 'max-w-[1600px]' : 'max-w-7xl'} mx-auto p-4 md:p-8`}>
