                        ...
                        <div className="flex justify-center pt-2 border-t border-gray-100/80">
                            <div className="overflow-x-auto no-scrollbar max-w-full">
                                <nav className="inline-flex items-center gap-1 bg-gray-100/50 p-1 rounded-2xl border border-gray-200/30 whitespace-nowrap min-w-max">
                                    ...
                                    <NavButton id="products" label="상품관리" icon="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                                    ...
                                    <NavButton id="customers" label="고객 관리" icon="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" count={newCustomerCount} />
            ...
            <main className={`${activeTab === 'retention2' ? 'max-w-[1600px]' : 'max-w-7xl'} mx-auto p-4 md:p-8`}>
                ...
                {activeTab === "requests" && isAdmin && (
                    <PartnerRequests
                        ...
                        allRequests={dashboardData.allRequests as any}
                        onRefresh={() => fetchData()}
