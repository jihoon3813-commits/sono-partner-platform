            ...
            content: (
                <div className="h-full bg-[#f2f4f6] p-10 flex flex-col justify-center">
                    <div className="max-w-[1250px] mx-auto w-full">
                        ...
                        {/* 24시간 긴급 장례 접수 안내 배너 */}
                        <div className="mt-8 bg-gradient-to-r from-[#2c0d12] via-[#0f172a] to-[#0f172a] border border-red-500/15 rounded-2xl p-6 sm:p-7 flex flex-col lg:flex-row justify-between items-center gap-6 shadow-2xl relative overflow-hidden text-left">
                            ...
                            <div className="flex-grow">
                                ...
                                <p className="text-slate-400 text-xs font-bold leading-relaxed mb-4 break-keep max-w-2xl">
